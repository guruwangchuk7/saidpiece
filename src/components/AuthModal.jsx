...
const AuthModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal Content */}
            <div className="relative z-10 w-full max-w-[340px] sm:max-w-md bg-white p-6 sm:p-10 shadow-2xl rounded-[2rem] mx-auto animate-in fade-in zoom-in duration-300 overflow-y-auto max-h-[90vh] custom-scrollbar">
                <button
                    onClick={() => setShowAuthModal(false)}
                ...
                <div className="text-center mb-6">
                    {savedRoute && (
                        <div className="mb-4 py-2 px-4 bg-blue-50 border border-blue-200 rounded-lg w-fit max-w-[200px] mx-auto">
                ...
                {successMsg ? (
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 hover:bg-gray-50 focus-visible:ring-transparent transition-all border-none"
                        >
                        ...
                        <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        className="block w-full border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm px-4 bg-gray-50 rounded-xl transition-all"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex w-full justify-center bg-black px-4 py-3 text-sm font-semibold leading-6 text-white shadow-lg hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:opacity-50 transition-all rounded-xl mt-2"
                                >
