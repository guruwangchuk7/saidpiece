...
const ThinleyDhendupPortfolio = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen relative flex items-start justify-center bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-10">
      <NavLink to="/team" className="absolute top-6 sm:top-10 left-7 sm:left-1 lg:left-26 flex items-center gap-2 text-xs sm:text-sm font-medium hover:underline z-20">
