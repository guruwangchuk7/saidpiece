...
function H1() {
  ...
  return (
    <div>
      <div className="relative min-h-[80vh] lg:h-[90vh] flex justify-center items-center text-neutral-900 px-4">
        <MotionConfig transition={{ duration: 3, type: "spring" }}>
          <motion.div
            className="head text-center w-fit mx-auto -mt-32 md:-mt-20"
        ...
        <motion.div
          className="absolute bottom-20 md:bottom-12 flex flex-col items-center gap-3 cursor-pointer"
      ...
      <div ref={imageRef} className="h-auto sm:h-[82vh] md:h-[92vh] mx-3 sm:mx-5 md:mx-10 lg:mx-[12vw] mt-10 sm:mt-[20vh] lg:mt-[10vh] overflow-hidden flex justify-center items-center">
        <img
          src={kinleyPhoto}
          alt="Kinley"
