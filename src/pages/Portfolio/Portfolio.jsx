...
const portfolioItems = [
  { id: 1, image: photo1, title: 'Clock Tower', subtitle: 'Recreational area', location: 'Thimphu' },
  { id: 2, image: photo2, title: 'Heritage House', subtitle: 'Cultural restoration', location: 'Punakha' },
  { id: 3, image: photo3, title: 'Lotus Pavilion', subtitle: 'Public pavilion', location: 'Paro' },
  { id: 4, image: photo4, title: 'Riverfront', subtitle: 'Landscape design', location: 'Wangdue' },
  { id: 5, image: photo5, title: 'Mountain Retreat', subtitle: 'Resort design', location: 'Thimphu' },
  { id: 6, image: photo6, title: 'Community Center', subtitle: 'Modern communal space', location: 'Mongar' },
];
