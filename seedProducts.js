...
// We need to read the JS file as text and extract the array
// Or better, just copy the products array here for the one-time script
const products = [
    {
...
async function seedProducts() {
    ...
    // First, let's clear existing products just to be safe and avoid duplicates on re-run
    ...
    console.log(`\nSeeding complete! Successfully inserted ${successCount} out of ${products.length} products.`);
}
